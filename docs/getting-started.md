...
- **[The Nautomation Prime Foundation](foundation/index.md)** — Our free arm: all learning content, plus free and low-cost engineering for registered UK charities and CICs
- **[Tutorials](foundation/tutorials/index.md)** — Step-by-step practical guides for learning automation skills
- **[Deep Dives](foundation/deep-dives/index.md)** — Production-ready scripts explained line-by-line
...
Start with our **[Tutorials](foundation/tutorials/index.md)**. We provide hands-on, step-by-step guides for beginner, intermediate, and expert levels.

**Recommended Learning Path:**

1. **[Beginner Tutorials](foundation/tutorials/beginner/index.md)** — Your first Netmiko scripts
   - [Show Command to Excel](foundation/tutorials/beginner/netmiko-show-command-to-excel.md) — Start here
   - [Multi-Device Automation](foundation/tutorials/beginner/multi-device-show-command.md) — Scale to multiple devices

2. **[Intermediate Topics](foundation/tutorials/intermediate/index.md)** — Configuration management, validation, templating

3. **[Expert Topics](foundation/tutorials/expert/index.md)** — Nornir, AsyncIO, advanced patterns

4. **[Deep Dives](foundation/deep-dives/index.md)** — Production-grade code walkthroughs
   - [CDP Network Audit](foundation/deep-dives/cdp-audit.md) — Threading, security, enterprise design
...
- [Access Switch Audit](foundation/deep-dives/access-switch-audit.md) — Port health and compliance checking
...
1. Read the [Deep Dive guide](foundation/deep-dives/cdp-audit.md) to see exactly how it works
...
??? question "What's the difference between tutorials, deep dives, and services?"
    ...
    **[Tutorials](foundation/tutorials/index.md)** teach you to build automation yourself with step-by-step guides. **[Deep Dives](foundation/deep-dives/index.md)** explain production-grade scripts line-by-line so you understand how they work. **[Services](services.md)** deliver complete automation projects through the **[PRIME Framework](prime-framework/index.md)** with ROI proof and team empowerment.
...
- **Learn Network Automation:** Start with [Tutorials](foundation/tutorials/index.md) or study [Deep Dives](foundation/deep-dives/index.md)
